        ...
        <div class="flex justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <a href="?page=manage-apps">
                    <img src="/wantedauth-logo.svg" alt="WantedAuth Icon"
            ...
            <div id="dropdownDotsHorizontal"
                ...
                <ul class="py-2 text-white text-xs" aria-labelledby="dropdownMenuIconHorizontalButton">
                    <li>
                        <a href="?page=manage-apps" class="block px-4 py-2 hover:opacity-60 inline-flex">
                            <i class="lni lni-dashboard mr-2 mt-1"></i>Dashboard
                        </a>
                    </li>
                    <li>
                        <a href="?page=account-settings" class="block px-4 py-2 hover:opacity-60 inline-flex">
                            <i class="lni lni-cog mr-2 mt-1"></i>Account Settings
                        </a>
                    </li>
                </ul>
            </div>
