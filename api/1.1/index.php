...
switch ($_POST['type'] ?? $_GET['type']) {
    case 'init':
        ...
        if($duplicateSession) {
            ...
            $updateSession = misc\cache\update('WantedAuthState:'.$secret.':'.$sessionid.'', array("validated" => 0));
            if(!$updateSession) {
        ...
        if($newSession) {
            misc\cache\insert("WantedAuthState:$secret:$sessionid", serialize(array("credential" => NULL, "enckey" => NULL, "validated" => 0)), $sessionexpiry);
